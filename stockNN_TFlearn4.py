...
it read hyper parameters from a csv file "HyperParamSearchPlan.csv" and train models accordingly,
then save those models to disk,  evaluate each model with pre-defined training set and test set, record their metrics,
such as AUC, accuracy,F1 score, save the file location
"""
...
def main():
    ...
    for seqid in range(0, hpIns.rows.__len__()):
        ...
        if trainDataChanged:
            ...
            # plotFeatures(training_set.data,training_set.featurenames,[1],hpDict["TFromDate"]+hpDict["TToDate"],
        ...
        if not preProcessChanged:
            if trainDataChanged:
                ...
                # hpDict['Preprocessor']+str(seqid)+'train',savePlotToDisk=True,scatterAdjust=False)
        ...
        try:
            ...
            modelStore.evaluate(seqid, mymodel, dp, X, y, X_test, y_test)
